            ...
            [
              {
                columns: [
                  ...
                  {text: this.user.fullname, fontSize: 15, width: 'auto', style: {bold: true}},
                ],
                columnGap: 10,
              },
              {
                columns: [
                  ...
                  {text: '', fontSize: 15, width: 'auto', style: {bold: true}},
                ],
                columnGap: 10,
              },
              {
                columns: [
                  ...
                  {text: moment(this.dia_inicio).locale('es').format('LL'), fontSize: 15, width: 'auto', style: {bold: true}},
                  {text: 'al', fontSize: 15, width: 'auto'},
                  {text: moment(this.dia_fin).locale('es').format('LL'), fontSize: 15, width: 'auto', style: {bold: true}},
                ],
                columnGap: 5,
              },
            ],
